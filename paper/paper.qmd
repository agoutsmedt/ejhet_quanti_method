...
author: |
  \name{First Author\textsuperscript{a}\thanks{CONTACT First Author. Email: first.author@uni.edu} and Second Author\textsuperscript{b}}
  \affil{\textsuperscript{a}Affiliation A, City, Country; \textsuperscript{b}Affiliation B, City, Country}
...
::: callout-warning
### Warning
This intermediate version of the paper is a work in progress. The section discussion in particular will be expanded in future versions.
:::

::: callout-note 
### Interative application to explore the data 
We develop an interactive application to explore the data and results presented in this paper. It is available at: [https://01991571-69e4-c794-6467-f1ca83d7c257.share.connect.posit.cloud/](https://01991571-69e4-c794-6467-f1ca83d7c257.share.connect.posit.cloud/). The first tab allows to explore the networks, while the second tab is a global summary of textual clusters.
::: 
...
::: {.landscape}
![Alluvial plot of clusters of sentences about rationality](images/alluvial_llm.png){#fig-llm-alluvial}
::: 
...
![Relative citation of a selection of seminal papers on behavioral economics](images/citation_patterns.jpg){#fig-rationality-paper-citations}

::: {.landscape}
![Alluvial plot of clusters of sentences about rationality](images/alluvial_network.jpg){#fig-biblio-alluvial}
:::

![Example of one bibliographic network representing one horizontal bar of Alluvial (@fig-biblio-alluvial)](images/network_example.png)
