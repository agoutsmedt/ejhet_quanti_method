...
1. Determined "representative vectors" for the concept of rationality.
2. Retrieved the most similar sentences in the corpus from this vector.
3. Grouped those sentences into clusters.
::: 
::: 
:::: 
