...
In addition to the interactive application, an alluvial diagram is generated to map the flow of these clusters over time (see @fig-alluvial). This visualization allows us to trace the genesis, growth, merging, splitting, and decline of specific intellectual communities across decades. 

We also track this transformations in our application.
