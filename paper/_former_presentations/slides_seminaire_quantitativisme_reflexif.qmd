...
- Si les méthodes quantitatives s'implantent récemment en HPE, quelles sont les méthodes utilisées. 
  ...
  - Fil commun : méthodes non-supervisées. Découverte de structure dans les données sans présager de ce que pourrait être cette structure; identification de catégories émergentes.
...
- Points faibles: beaucoup d'informations avec la nécessité de zoomer. Trop de couleurs. Pas de détails sur les cluster à chaque période car aggrégation. Que représente les flux? Rien !
...
- Oublier les couleurs. Chaque point est un cluster dans une décennie. Les liens sont la similarité. Méthode de pruning pour ne garder que les liens les plus significatifs statistiquement. 
