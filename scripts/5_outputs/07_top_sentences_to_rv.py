...
INPUT_FILE  = os.path.join(paths.ejhet_project_data_path, "closest_sentences_0.01_rationality_score_filtered_with_embeddings.feather")
OUTPUT_FILE = os.path.join(paths.ejhet_project_data_path, "top_sentences_to_fake_sentence.feather")
...
metadata = feather.read_feather(os.path.join(paths.ejhet_project_data_path, "metadata_maintext.feather"))
