...
graphs <- data_app$graphs
closest_sentences <- data_app$closest_sentences
top_refs <- data_app$top_refs
top_refs_without_id <- data_app$top_refs_without_id
cluster_origins <- data_app$cluster_origins
cluster_destinies <- data_app$cluster_destinies
tf_idf <- data_app$tf_idf
rm(data_app)
